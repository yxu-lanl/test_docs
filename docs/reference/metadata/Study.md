...
| ---  | --- | --- | --- |
| [emsl_project_identifiers](emsl_project_identifiers.md) | 0..* <br/> [ExternalIdentifier](ExternalIdentifier.md) | Identifiers that link a NMDC study to the EMSL user facility website hosting ... | direct |
