# Class: Read based analysis activity (ReadBasedTaxonomyAnalysisActivity)


_A workflow execution activity that performs taxonomy classification using sequencing reads_





URI: [nmdc:ReadBasedTaxonomyAnalysisActivity](https://w3id.org/nmdc/ReadBasedTaxonomyAnalysisActivity)
...
```mermaid
classDiagram
  class ReadBasedTaxonomyAnalysisActivity
    WorkflowExecutionActivity <|-- ReadBasedTaxonomyAnalysisActivity
    
    
    
  ReadBasedTaxonomyAnalysisActivity : ended_at_time
    
  ReadBasedTaxonomyAnalysisActivity : execution_resource
    
  ReadBasedTaxonomyAnalysisActivity : git_url
    
  ReadBasedTaxonomyAnalysisActivity : has_failure_categorization
    
    ReadBasedTaxonomyAnalysisActivity --|> FailureCategorization : has_failure_categorization
    
  ReadBasedTaxonomyAnalysisActivity : has_input
    
    ReadBasedTaxonomyAnalysisActivity --|> NamedThing : has_input
    
  ReadBasedTaxonomyAnalysisActivity : has_output
    
    ReadBasedTaxonomyAnalysisActivity --|> NamedThing : has_output
    
  ReadBasedTaxonomyAnalysisActivity : id
    
  ReadBasedTaxonomyAnalysisActivity : name
    
  ReadBasedTaxonomyAnalysisActivity : part_of
    
    ReadBasedTaxonomyAnalysisActivity --|> NamedThing : part_of
    
  ReadBasedTaxonomyAnalysisActivity : qc_comment
    
  ReadBasedTaxonomyAnalysisActivity : qc_status
    
    ReadBasedTaxonomyAnalysisActivity --|> StatusEnum : qc_status
    
  ReadBasedTaxonomyAnalysisActivity : started_at_time
    
  ReadBasedTaxonomyAnalysisActivity : type
    
  ReadBasedTaxonomyAnalysisActivity : used
    
  ReadBasedTaxonomyAnalysisActivity : version
    
  ReadBasedTaxonomyAnalysisActivity : was_informed_by
    
    ReadBasedTaxonomyAnalysisActivity --|> Activity : was_informed_by
...
| ---  | --- | --- | --- |
| [Database](Database.md) | [read_based_taxonomy_analysis_activity_set](read_based_taxonomy_analysis_activity_set.md) | range | [ReadBasedTaxonomyAnalysisActivity](ReadBasedTaxonomyAnalysisActivity.md) |
...
| ---  | ---  |
| self | nmdc:ReadBasedTaxonomyAnalysisActivity |
| native | nmdc:ReadBasedTaxonomyAnalysisActivity |
...
<details>
```yaml
name: ReadBasedTaxonomyAnalysisActivity
...
attributes:
  type:
    ...
    rank: 1000
    alias: type
    owner: ReadBasedTaxonomyAnalysisActivity
    domain_of:
    - DataObject
    - Biosample
    - Study
