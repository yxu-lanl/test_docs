...
classDiagram
  ...
  MetagenomeSequencingActivity : has_failure_categorization
    
    MetagenomeSequencingActivity --|> FailureCategorization : has_failure_categorization
  ...
  MetagenomeSequencingActivity : qc_comment
    
  MetagenomeSequencingActivity : qc_status
    
    MetagenomeSequencingActivity --|> StatusEnum : qc_status
