...
URI: [nmdc:NomAnalysisActivity](https://w3id.org/nmdc/NomAnalysisActivity)
...
classDiagram
  ...
  NomAnalysisActivity : ended_at_time
    
  NomAnalysisActivity : execution_resource
    
  NomAnalysisActivity : git_url
    
  NomAnalysisActivity : has_calibration
    
  NomAnalysisActivity : has_failure_categorization
    
    NomAnalysisActivity --|> FailureCategorization : has_failure_categorization
    
  NomAnalysisActivity : has_input
    
    NomAnalysisActivity --|> NamedThing : has_input
    
  NomAnalysisActivity : has_output
    
    NomAnalysisActivity --|> NamedThing : has_output
    
  NomAnalysisActivity : id
    
  NomAnalysisActivity : name
    
  NomAnalysisActivity : part_of
    
    NomAnalysisActivity --|> NamedThing : part_of
    
  NomAnalysisActivity : qc_comment
    
  NomAnalysisActivity : qc_status
    
    NomAnalysisActivity --|> StatusEnum : qc_status
    
  NomAnalysisActivity : started_at_time
    
  NomAnalysisActivity : type
    
  NomAnalysisActivity : used
    
  NomAnalysisActivity : version
    
  NomAnalysisActivity : was_informed_by
    
    NomAnalysisActivity --|> Activity : was_informed_by
...
| ---  | --- | --- | --- |
| [Database](Database.md) | [nom_analysis_activity_set](nom_analysis_activity_set.md) | range | [NomAnalysisActivity](NomAnalysisActivity.md) |
...
| ---  | ---  |
| self | nmdc:NomAnalysisActivity |
| native | nmdc:NomAnalysisActivity |
