# Slot: has_failure_categorization

URI: [nmdc:has_failure_categorization](https://w3id.org/nmdc/has_failure_categorization)
...
* Range: [FailureCategorization](FailureCategorization.md)
