...
classDiagram
  ...
  MetabolomicsAnalysisActivity : has_failure_categorization
    
    MetabolomicsAnalysisActivity --|> FailureCategorization : has_failure_categorization
  ...
  MetabolomicsAnalysisActivity : qc_comment
    
  MetabolomicsAnalysisActivity : qc_status
    
    MetabolomicsAnalysisActivity --|> StatusEnum : qc_status
